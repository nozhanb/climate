...
high3 = codecs.open('DivQAverageLand_1982_1988_'+month+'_10W40E_35N75N','r').read()
...
low3 = codecs.open('DivQAverageLand_1984_1985_'+month+'_10W40E_35N75N','r').read()
low2 = json.loads(low3)
low = numpy.array(low2)

highIndex3 = codecs.open('DivQIndexLand_1982_1988_'+month+'_10W40E_35N75N','r').read()
...
lowIndex3 = codecs.open('DivQIndexLand_1984_1985_'+month+'_10W40E_35N75N','r').read()
...
plt.savefig('/home/nba035/plot/lowMinusAverageAnomalies'+month+'.eps',dpi = 80, format = 'eps')
